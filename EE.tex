    ...
    \section{Experiment}
        ...
        \subsection{Analysis of results}
            \subsubsection*{Graphs}    
                ...
                Observing the graph, we can see a few abnormal behaviors as $l_n \to 0$. The function has a zero at 0.0032,  I can take the first derivative of this with respect to $l_n$ to analyze further. The graph of the first derivative has a zero at approx. 0.0048, indicating there is an extremum of the initial function at this point that is not shown on the graph. Plugging $l_n = 0.0048$ into the initial function, it returns a value of approx. \SI{3193}{Hz}, so this is a very large maximum.
