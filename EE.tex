    ...
    \section{Experiment}
        ...
        \subsection{Tables of results}
            ...
            \begin{itemize}
                ...
                $l_n = \frac{.648}{\sqrt[12]{2^7}} = \SI{.432}{m}$
                \item Average frequency is simply average value of the 5 trials. \\
                avg.$f = \frac{294.98 + 294.98 + 294.99 + 294.98 + 294.99 }{5} = \SI{294.98}{Hz}$
                ...
                \item Uncalibrated $\Delta f$ is the difference between the average and the standard frequency. \\
                Uncalibrated $\Delta f = 294.98 - 293.66 = \SI{1.32}{Hz}$
                \item $\Delta f$ is the intonation deviation at each fret, after taking into account the intonation difference at $f_0$.\\
                $\Delta f = 1.32 - .22 = \SI{1.10}{Hz}$
                \item Absolute uncertainty of $\Delta f$ is half the range of trial values, taken to 1 s.f\\
                Abs. unc. of $\Delta f = (294.99-294.98)/2 = 0.005$
            \end{itemize}
