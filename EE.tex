    ...
    \section{Experiment}
        ...
        \subsection{Analysis of results}
            \subsubsection*{Graphs}    
                After collecting the data, I can take the average value of $f_0 = \SI{196.22}{Hz}$ as the constant value of $f_0$ for Equation (\ref{eqn31}). Now I can plot the graph relating $\Delta f$ and $l_n$. The range of the graph will correspond with the distance between the nut and the highest fret of the guitar, where the fretboard is. My guitar has 22 fret, therefore\\
                \begin{align*}
                    l_22 = \frac{.648}{2^{\frac{22}{12}}} = \SI{0.182}{Hz}
                \end{align*} 
                Therefore the range I will be graphing is $\{0.182 \le l_n \le 0.648 \}$. Below is the general form of the graph with the constants. \\
                \begin{figure}[h!]
